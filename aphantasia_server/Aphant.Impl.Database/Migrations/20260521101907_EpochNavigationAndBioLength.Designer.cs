...
namespace Aphant.Impl.Database.Migrations
{
    ...
    [Migration("20260521101907_EpochNavigationAndBioLength")]
    partial class EpochNavigationAndBioLength
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Aphant.Impl.Database.Entity.EpochEntity", b =>
                {
                    ...
                    b.Property<int?>("NextEpochId")
                        .HasColumnType("integer")
                        .HasColumnName("next_epoch_id");

                    b.Property<int?>("PreviousEpochId")
                        .HasColumnType("integer")
                        .HasColumnName("previous_epoch_id");
                    ...
                    b.HasIndex("NextEpochId")
                        .HasDatabaseName("ix_epochs_next_epoch_id");

                    b.HasIndex("PreviousEpochId")
                        .HasDatabaseName("ix_epochs_previous_epoch_id");
            ...
            modelBuilder.Entity("Aphant.Impl.Database.Entity.EpochEntity", b =>
                {
                    b.HasOne("Aphant.Impl.Database.Entity.EpochEntity", "NextEpoch")
                        .WithMany()
                        .HasForeignKey("NextEpochId")
                        .HasConstraintName("fk_epochs_epochs_next_epoch_id");

                    b.HasOne("Aphant.Impl.Database.Entity.EpochEntity", "PreviousEpoch")
                        .WithMany()
                        .HasForeignKey("PreviousEpochId")
                        .HasConstraintName("fk_epochs_epochs_previous_epoch_id");

                    b.Navigation("NextEpoch");

                    b.Navigation("PreviousEpoch");
                });
